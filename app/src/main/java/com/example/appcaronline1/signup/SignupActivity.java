        ...
        btConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(verifyFromSQLite() ){
                    ...
                    account.setUserName_422(textInputEditTextUserName.getText().toString().trim());
                    account.setPassWord_422(textInputEditTextPassword.getText().toString().trim());
                    account.setName_422(textInputEditTextName.getText().toString());
                    account.setEmail_422(textInputEditTextEmail.getText().toString().trim());
                    account.setPhoneNumber_422(textInputEditTextPhoneNumber.getText().toString().trim());
                    if(rgGioiTinh.getCheckedRadioButtonId()==R.id.rb_signup_nam){
                        account.setGioiTinh_422(1);
                    } else {
                        account.setGioiTinh_422(0);
                    }

...
public class LoginActivity extends AppCompatActivity {
    ...
    public void createAdmin(){
        ...
        account.setUserName_422("admin");
        account.setPassWord_422("123");
        account.setName_422("chung");
        account.setGioiTinh_422(1);
        account.setEmail_422("hoangchung1687@gmail.com");
        account.setPhoneNumber_422("0333539973");
    ...
    public Account getAccountLogin(String username){
        ...
        for(int i=0;i<accountArrayList.size();i++) {
            if(username.trim().equals(accountArrayList.get(i).getUserName_422())){
